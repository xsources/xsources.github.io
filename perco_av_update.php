...
if(isset($_POST['add']) && empty($_POST['snum'])){
    $x = 220;
}
echo "N=".$x;
?>
<input type="text" name="snum" value="<?php echo $x;?>">   		   
...
def plot(a=0):
    ...
    p=sB/(N*N); 
    im = ax.imshow(D, cmap);
    plt.title('(Author: Said Boutiche)', x=0.1,y=-0.12)
    display("p= ",p," Larg. Comp.= ",C.sum()," Concentr.= ",B.sum())
  
a_slider = widgets.IntSlider(min=0, max=N*N, step=10, value=10)
interactive(plot,a=a_slider)
